...
my $sql = "(select player,nfl_team,position,ffl_team,total_pts from players_QB where value = 2 and total_pts > 0)"
        . " union (select player,nfl_team,position,ffl_team,total_pts from players_WR where value = 2 and total_pts > 0)"
        . " union (select player,nfl_team,position,ffl_team,total_pts from players_RB where value = 2 and total_pts > 0)"
        . " union (select player,nfl_team,position,ffl_team,total_pts from players_TE where value = 2 and total_pts > 0)"
        . " union (select player,nfl_team,position,ffl_team,total_pts from players_K where value = 2 and total_pts > 0)"
