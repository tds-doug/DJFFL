...
print "<center>Current Week: <font color=\"#FF0000\">$week</font>\n</center>";
print "<p>\n";
...
# Begin -  FFL Teams Section
print "<tr><td>\n";
print "<center><font color=\"#FFFFDF\">FFL Teams</font></center>\n";
print "<ul>\n";
...
print "</ul>\n";
print "</td></tr>\n";
# End -  FFL Teams Section

# Begin - Week to Week Section
print "<tr><td>\n";
...
#  Begin -  Scores and Standings Section
print "<tr><td>\n";
print "<center><font color=\"#FFFFDF\">Scores and Standings</font></center>\n";
print "<ul>\n";
...
print "</ul>\n";
print "</td></tr>\n";
#  End -  Scores and Standings Section

# Begin - Players Section
print "<tr><td>\n";
...
# Begin - Free Agent Market and Draft Section
print "<tr><td>\n";
...
print "</ul>\n";
print "</td></tr>\n";
# End - Free Agent Market and Draft Section

# Begin - General League Mgmt Section
print "<tr><td>\n";
...
print "</ul>\n";
print "</td></tr>\n";
# End - General League Mgmt Section
...
# v3.15 - Reorganized the categories to make groupings more logical
...
print "<p>\n";
print "Website version 3.15<br>\n";

# Last Updated to give mgr's idea of when I have updated site
print "Last updated 30 October 2015\n";
print "</center></font>\n";
print end_html();
