...
if(param( 'f_pick' ))
{
  ...
  open(TMPLOG,">/tmp/tmplog");
  print TMPLOG "To: $ffl_team,mmfratboy\@gmail.com\n";
  print TMPLOG "From: djffl.commish\@gmail.com\n";
  print TMPLOG "Subject: DLFFL 2015 Elimination Pick - date\n";
  print TMPLOG "On date $ffl_team changed their elimination pick to be $elim_pick.\n";
  print TMPLOG "If this action was not taken by you please contact DJ immediately.\n";
  print TMPLOG "Thank you for your support.\n"; 
  close(TMPLOG);
...
print "</center>\n";
  ...
  open(TMPLOG,">/tmp/tmplog");
  print TMPLOG "To: $ffl_manager,mmfratboy\@gmail.com\n";
  print TMPLOG "From: djffl.commish\@gmail.com\n";
  print TMPLOG "Subject: DLFFL 2015 Elimination Pick - date\n";
  print TMPLOG "On date $ffl_manager changed their elimination pick to be elim_pick.\n";
  print TMPLOG "If this action was not taken by you please contact DJ immediately.\n";
  print TMPLOG "Thank you for your support.\n";
  close(TMPLOG);
