...
my $tempweek = Foozeball::admin_getweek();
#my $tempweek = 17;
...
while (my $row = $sth->fetchrow_arrayref)
{
  ...
  print "<tr>\n";
    ...
    print "<td><center><img src=\"http://www.djffl.net/images/$row->[4]_h.gif\"></center></td>\n";
#    print "<td><center><img src=\"http://192.168.1.175/images/$row->[4]_h.gif\"></center></td>\n";
